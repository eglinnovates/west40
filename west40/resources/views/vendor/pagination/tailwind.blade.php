@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}"
     class="w-fit mx-auto flex items-center justify-center gap-4">
        ...
        <div class="hidden sm:flex sm:items-center sm:justify-between sm:gap-6">
            <div>
                <p class="text-sm text-gray-700 leading-5 dark:text-gray-400 sm:mr-2">
                    {!! __('Showing') !!}
            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md sm:ml-2">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
